...
class Employees(Base):
    ...
    employeeid: Mapped[int] = mapped_column(Integer, autoincrement=True)
...
class Orders(Base):
    ...
    orderid: Mapped[int] = mapped_column(Integer, autoincrement=True)
    customerid: Mapped[str] = mapped_column(String(5))
...
class Shippers(Base):
    ...
    shipperid: Mapped[int] = mapped_column(Integer)
